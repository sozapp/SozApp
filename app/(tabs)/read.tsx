          ...
          >
            {currentContextNote != null && (
              <>
                ...
                <Pressable
                  style={styles.contextModalClose}
                  onPress={() => setContextModalVisible(false)}
                  hitSlop={12}
                >
                ...
                <ScrollView style={styles.contextScroll} showsVerticalScrollIndicator={false}>
                  <Text style={styles.contextChapterLabel}>
                    {currentBook.name} · {chapter.chapterNumber}. Bölüm
                  </Text>
                  <Text style={[styles.contextModalTitle, { color: theme.text }]}>
                    {currentContextNote.title}
                  </Text>
                  ...
                  <Text style={[styles.contextHistorical, { color: theme.textMuted }]}>
                    {currentContextNote.historicalContext}
                  </Text>
                  <View style={[styles.contextDivider, { backgroundColor: theme.textMuted }]} />
                  <Text style={[styles.contextSectionLabel, { color: theme.textMuted }]}>
                  ...
                  <View style={styles.contextKeyVerseWrap}>
                    <Text style={styles.contextKeyVerse}>
                      {currentContextNote.keyVerse}
                    </Text>
                    {currentContextNote.keyQuote ? (
                  ...
                  {(() => {
                    const relatedVideo = getRelatedVideo(currentBook.id, chapter.chapterNumber);
                      ...
                      <>
                        ...
                        >
                          ...
                          <View style={styles.contextVideoBody}>
                            <Text style={[styles.contextVideoTitle, { color: theme.text }]} numberOfLines={2}>
                              {relatedVideo.title}
                            </Text>
                  ...
                  <View style={styles.askSozSection}>
                        ...
                        setTimeout(() => {
                          router.push({
                            ...
                            params: {
                              prefill:
                                `${currentBook.name} ` +
                                `${chapter.chapterNumber}. bölümü ` +
                                `hakkında daha fazla bilgi ver. ` +
                                `Tarihsel bağlamı, yazarı ve ` +
                                `ana mesajı açıkla.`,
                            },
                          });
                        }, 300);
                    ...
                    <View style={styles.quickQuestionsWrap}>
                      {[
                        `${currentBook.name} ${chapter.chapterNumber} kim yazdı?`,
                        'Bu bölümün ana mesajı nedir?',
                        'Bu dönemde neler yaşanıyordu?',
                      ].map((question, i) => (
                        <TouchableOpacity
                          key={i}
                          style={[styles.quickQuestionChip, { borderColor: 'rgba(196,149,80,0.35)', backgroundColor: 'rgba(196,149,80,0.05)' }]}
                          onPress={() => {
                            setContextModalVisible(false);
                            setTimeout(() => {
                              router.push({
