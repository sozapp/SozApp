/** Vahiy — Türkçe Kutsal Kitap (Yeni Çeviri) 2001 ayet metinleri */
export const REVELATION_CHAPTER_VERSES: string[][] = [
  // Vahiy 1 (20 ayet)
  [
    ...
    "Yücelik ve güç sonsuzlara dek Mesih'in olsun!",
    "Bizi seven, kanıyla bizi günahlarımızdan özgür kılmış ve bizi bir krallık haline getirip Babası Tanrı'nın hizmetinde kâhinler yapmış olan Mesih'in olsun! Amin.",
  ...
  [
    ...
    "«Ama size, yani Tiyatira'da bulunan öbürlerine, bu öğretiyi benimsememiş, Şeytan'ın sözde derin sırlarını öğrenmemiş olanların hepsine şunu söylüyorum:",
    "Ben gelinceye dek sizde olana sımsıkı sarılın. Üzerinize bundan başka bir yük koymuyorum.",
    "Galip gelene, yaptığım işleri sonuna dek sürdürene ulusların üzerinde yetki vereceğim. Ben Babam'dan nasıl yetki aldımsa,",
    "demir çomakla güdecek onları, çömlek gibi kırıp parçalayacaktır.",
  ...
  [
    ...
    "Yaratıklar tahtta oturanı, sonsuzluklar boyunca yaşayanı yüceltip ona saygı ve şükran sundukça,",
    "yirmi dört ihtiyar tahtta oturanın, sonsuzluklar boyunca yaşayanın önünde yere kapanarak O'na tapınıyorlar. Taçlarını tahtın önüne koyarak şöyle diyorlar:",
  ...
  [
    ...
    "«Amin! Övgü, yücelik, bilgelik, Şükran, saygı, güç, kudret, Sonsuzluklar boyunca Tanrımız'ın olsun! Amin!»",
  ...
  [
    ...
    "Elinde açılmış küçük bir tomar vardı. Sağ ayağını denize, sol ayağını karaya koyarak aslanın kükremesini andıran yüksek sesle bağırdı.",
    "O bağırınca, yedi gök gürlemesi dile gelip seslendiler.",
  ...
  [
    ...
    "Yedinci melek borazanını çaldı. Gökte yüksek sesler duyuldu: «Dünyanın egemenliği Rabbimiz'in ve Mesihi'nin oldu. O sonsuzluklar boyunca egemenlik sürecek.»",
    "Tanrı'nın önünde tahtlarında oturan yirmi dört ihtiyar yüzüstü yere kapandı. Tanrı'ya tapınarak şöyle dediler:",
    "«Her Şeye Gücü Yeten, Var olan, var olmuş olan Rab Tanrı! Sana şükrediyoruz. Çünkü büyük gücünü kuşanıp Egemenlik sürmeye başladın.",
  ...
  [
    ...
    "Gökte savaş oldu. Mikail'le melekleri ejderhayla savaştılar.",
    "Ejderha kendi melekleriyle birlikte karşı koydu, ama gücü yetmedi. Bu yüzden gökteki yerlerini yitirdiler.",
  ...
  [
    ...
    "Onları üçüncü bir melek izledi. Yüksek sesle şöyle diyordu: «Bir kimse canavara ve heykeline taparsa, alnına ya da eline canavarın işaretini koydurursa,",
    "Tanrı gazabının kâsesinde saf olarak hazırlanmış Tanrı öfkesinin şarabından içecektir. Böylelerine kutsal meleklerin ve Kuzu'nun önünde ateş ve kükürtle işkence edilecek.",
  ...
  [
    ...
    "Tanrı kulu Musa'nın ve Kuzu'nun ezgisini söylüyorlardı: «Her Şeye Gücü Yeten Rab Tanrı, Senin işlerin büyük ve şaşılası işlerdir. Ey ulusların kralı, Senin yolların doğru ve adildir.",
  ...
  [
    ...
    "Gökten başka bir ses işittim: «Ey halkım! Onun günahlarına ortak olmamak, Uğradığı belalara uğramamak için çık oradan!",
    ...
    "Altını, gümüşü, değerli taşları, incileri, ince keteni, ipeği, mor ve kırmızı kumaşları, her çeşit kokulu ağacı, fildişinden yapılmış her çeşit eşyayı, en pahalı ağaçlardan, tunç, demir ve mermerden yapılmış her çeşit malı,",
    "tarçın ve kakule, buhur, güzel kokulu yağ, günnük, şarap, zeytinyağı, ince un ve buğdayı, sığırları, koyunları, atları, arabaları ve köleleri, insanların canını satın alacak kimse yok artık.",
    ...
    "Onca büyük zenginlik Bir saat içinde yok oldu.'»",
  ...
  [
    ...
    "İkinci kez, «Haleluya! Onun dumanı sonsuzluklara dek tütecek» dediler.",
    ...
    "«Kralların, komutanların, güçlü adamların, atlarla binicilerinin, özgür köle, küçük büyük, hepsinin etini yemek için toplanın, Tanrı'nın büyük şölenine gelin!»",
  ...
  [
    ...
    "Onları saptıran İblis ise canavarla sahte peygamberin de içinde bulunduğu ateş ve kükürt gölüne atıldı. Gece gündüz, sonsuzluklara dek işkence çekeceklerdir.",
  ...
  [
    ...
    "Sonra melek beni Ruh'un yönetiminde büyük, yüksek bir dağa götürdü. Oradan bana gökten, Tanrı'nın yanından inen kutsal kenti, Yeruşalim'i gösterdi.",
    "Kent, O'nun görkemiyle ışıldıyordu. Kentin ışıltısı çok değerli bir taşın, billur gibi parıldayan yeşim taşının ışıltısına benziyordu.",
    ...
    "Kent surlarının temelleri her tür değerli taşla bezenmişti. Birinci temel taşı yeşim, ikincisi laciverttaşı, üçüncüsü akik, dördüncüsü zümrüt, beşincisi damarlı akik, altıncısı kırmızı akik, yedincisi sarı yakut, sekizincisi beril,",
    "dokuzuncusu topaz, onuncusu sarıca zümrüt, on birincisi gökyakut, on ikincisi ametistti.",
