...
export const REVELATION_CHAPTER_VERSES: string[][] = [
  ...
  [
    ...
    "Yaratıklar tahtta oturanı, sonsuzluklar boyunca yaşayanı yüceltip ona saygı ve şükran sundukça, yirmi dört ihtiyar tahtta oturanın, sonsuzluklar boyunca yaşayanın önünde yere kapanarak O'na tapınıyorlar. Taçlarını tahtın önüne koyarak şöyle diyorlar:",
  ...
  [
    ...
    "Sonra gündoğusundan yükselen başka bir melek gördüm. Yaşayan Tanrı'nın mührünü taşıyordu. Karaya, denize zarar vermek için yetki verilen dört meleğe yüksek sesle bağırdı: «Biz Tanrımız'ın kullarını alınlarından mühürleyene dek karaya, denize ya da ağaçlara zarar vermeyin!»",
  ...
  [
    ...
    "Sulardan sorumlu meleğin şöyle dediğini işittim: «Var olan, var olmuş olan kutsal Tanrı! Bu yargılarında adilsin. Kutsalların ve peygamberlerin kanını döktükleri için, İçecek olarak sen de onlara kan verdin. Bunu hak ettiler.»",
