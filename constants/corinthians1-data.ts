...
export const CORINTHIANS1_CHAPTER_VERSES: string[][] = [
  ...
  [
    ...
    "Mesih İsa'da kutsal kılınmış, kutsal olmaya çağrılmış olan sizlere ve hepimizin Rabbi İsa Mesih'in adını her yerde anan herkese selam!",
    "Babamız Tanrı'dan ve Rab İsa Mesih'ten lütuf ve esenlik olsun.",
    "Tanrı'nın Mesih İsa'da size bağışladığı lütuftan ötürü sizin için her zaman Tanrım'a şükrediyorum.",
    "Mesih'le ilgili tanıklığımız sizde pekiştiği gibi,",
    "Mesih'te her bakımdan –her tür söz ve bilgi bakımından– zenginleştiniz.",
    ...
    "Krispus'la Gayus'tan başka hiçbirinizi vaftiz etmediğim için Tanrı'ya şükrediyorum.",
    "Öyle ki, hiç kimse benim adımla vaftiz edildiğinizi söylemesin.",
  ...
  [
    ...
    "Size ilettiğimi ben Rab'den öğrendim.",
    "Ele verildiği gece Rab İsa eline ekmek aldı, şükredip ekmeği böldü ve şöyle dedi: «Bu sizin uğrunuza feda edilen bedenimdir. Beni anmak için böyle yapın.»",
