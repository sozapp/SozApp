/** Galatyalılar — Türkçe Kutsal Kitap (Yeni Çeviri) ayet metinleri */
export const GALATIANS_CHAPTER_VERSES: string[][] = [
  // Galatyalılar 1 (24 ayet)
  [
    "İnsanlarca ya da insan aracılığıyla değil, İsa Mesih ve O'nu ölümden dirilten Baba Tanrı aracılığıyla elçi atanan ben Pavlus'tan",
    "ve benimle birlikte olan bütün kardeşlerden Galatya'daki kiliselere selam!",
    ...
    "Ama beni daha annemin rahmindeyken seçip lütfuyla çağıran Tanrı,",
    "uluslara müjdelemem için Oğlu'nu bana göstermeye razı olunca hemen insanlara danışmadım;",
  ...
  [
    ...
    "Ancak yoksulları anımsamamızı istediler. Zaten ben de bunu yapmaya gayret ediyorum.",
  ...
  [
    ...
    "Ama zaman dolunca Tanrı, Yasa altında olanları özgürlüğe kavuşturmak için kadından doğan, Yasa altında doğan öz Oğlu'nu gönderdi.",
    "Öyle ki, bizler oğulluk hakkını alalım.",
  ...
  [
    ...
    "Benliğin işleri bellidir. Bunlar fuhuş, pislik, sefahattir.",
    "Putperestlik, büyücülük, düşmanlık, çekişme, kıskançlık, öfke, bencil tutkular, ayrılıklar, bölünmeler,",
    "çekememezlik, sarhoşluk, çılgın eğlenceler ve benzeri şeylerdir. Sizi daha önce uyardığım gibi yine uyarıyorum, böyle davrananlar Tanrı Egemenliği'ni miras alamayacaklar.",
