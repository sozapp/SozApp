/** Luka — Türkçe Kutsal Kitap (Yeni Çeviri) ayet metinleri */
export const LUKE_CHAPTER_VERSES: string[][] = [
  // Luka 1 (80 ayet)
  [
  ...
  [
    ...
    "Bölgenin kralı Hirodes bütün bu olanları duyunca şaşkına döndü. Çünkü bazıları Yahya'nın ölümden dirildiğini, bazıları İlyas'ın göründüğünü söylüyordu.",
    "Başkaları ise eski peygamberlerden birinin dirildiğini söylüyordu. Hirodes, \"Yahya'nın başını ben kestirdim. Şimdi hakkında böyle haberler duyduğum bu adam kim?\" diyor ve İsa'yı görmenin bir yolunu arıyordu.",
    ...
    "Herkes İsa'nın bütün yaptıkları karşısında hayret içindeyken, İsa öğrencilerine, \"Şu sözlerime iyice kulak verin\" dedi.",
  ...
  [
    ...
    "Ama bir kente girdiğinizde sizi kabul etmezlerse, o kentin caddelerine çıkıp şöyle deyin: 'Kentinizden ayaklarımızda kalan tozu bile size karşı silkiyoruz.",
    "Yine de şunu bilin ki, Tanrı'nın Egemenliği yaklaştı.'",
  ...
  // Luka 12 (59 ayet) — Türkçe Kutsal Kitap Yeni Çeviri
  [
    "Bu sırada binlerce kişi toplandı; öyle ki birbirlerini çiğneyecek gibiydiler. İsa önce öğrencilerine şöyle konuşmaya başladı: \"Ferisiler'in mayasından, yani ikiyüzlülükten sakının.",
    "Örtülü olan açığa çıkarılacak, gizlenen bilinecektir.",
    "Bunun için karanlıkta söyledikleriniz gün ışığında duyulacak, odalarda kulağa fısıldadıklarınız damlardan duyurulacaktır.\"",
    "\"Sizlere, dostlarım olanlara şunu söylüyorum: Bedeni öldüren, ama ondan sonra başka bir şey yapamayanlardan korkmayın.",
    "Kime korkmanız gerektiğini göstereyim: Öldürdükten sonra cehenneme atmaya yetkisi olana korkun. Evet, size söylüyorum, O'ndan korkun.\"",
    "\"Beş serçe iki meteliğe satılmıyor mu? Ama Tanrı onlardan birini bile unutmuyor.",
    "Aslında başınızdaki saçlar bile tek tek sayılıdır. Korkmayın, siz serçelerden çok daha değerlisiniz.\"",
    "\"Sizlere şunu söylüyorum: İnsanların önünde beni kabul eden herkesi, İnsanoğlu da Tanrı'nın melekleri önünde kabul edecek.",
    "Ama insanların önünde beni inkâr eden, Tanrı'nın melekleri önünde inkâr edilecektir.\"",
    "\"İnsanoğlu'na karşı söz söyleyen herkes bağışlanacak. Ama Kutsal Ruh'a küfreden bağışlanmayacaktır.\"",
    "Sizi havralara, yöneticilere ve yetkililere götürdüklerinde, \"Ne savunma yapmalıyız, ne söylemeliyiz?\" diye kaygılanmayın.",
    "Çünkü Kutsal Ruh o anda size ne söylemeniz gerektiğini öğretecektir.\"",
    ...
    "Rab şöyle dedi: \"Efendinin, uşaklarına vaktinde azık vermek için başlarına atadığı güvenilir ve akıllı kâhya kimdir?",
    ...
    "Ama o köle içinden, 'Efendim gecikiyor' der de kadın ve erkek hizmetkârları dövmeye, yiyip içip sarhoş olmaya başlarsa, efendisi onun beklemediği günde, ummadığı saatte gelecek, onu şiddetle cezalandırıp imansızlarla bir tutacaktır.",
  ...
  [
    ...
    "İsa onlara şöyle karşılık verdi: \"Böyle acı çeken bu Celileliler'in, bütün öbür Celileliler'den daha günahkâr olduğunu mu sanıyorsunuz?",
    ...
    "Buna göre, Şeytan'ın on sekiz yıldır bağlı tuttuğu, İbrahim'in kızı olan bu kadının da Şabat Günü bu bağdan çözülmesi gerekmez miydi?\"",
  ...
  [
    ...
    "Yemeğe çağrılanların başköşeleri seçtiğini fark eden İsa, onlara şu benzetmeyi anlattı: \"Biri seni düğüne çağırdığı zaman başköşeye kurulma. Belki senden daha saygın birini de çağırmıştır.",
    "İkinizi de çağıran gelip, 'Yerini bu adama ver' diyebilir. O zaman utançla kalkıp en arkaya geçersin.",
    "Bunun tersine, bir yere çağrıldığında git, en arkada otur. Öyle ki, seni çağıran gelince, 'Arkadaşım, daha öne buyur' desin. O zaman seninle birlikte sofrada oturan herkesin önünde onurlandırılmış olursun.",
    ...
    "Ne var ki hepsi özür dilemeye başladılar. Birincisi, 'Bir tarla satın aldım, gidip görmek zorundayım. Rica ederim, beni hoş gör' dedi.",
  ...
  // Luka 15 (32 ayet) — Kayıp koyun, kayıp oğul
  [
    ...
    "\"Bir adamın iki oğlu vardı\" dedi İsa.",
  ...
  [
    ...
    "İsa, \"İyileşenler on kişi değil miydi? Öbür dokuzu nerede?\" diye sordu.",
  ...
  // Luka 19 (48 ayet) — 1878 Kitab-ı Mukaddes uyarlaması
  [
    "İsa Eriha kasabasına girdi. Kasabanın içinden geçiyordu.",
    "Orada Zakkay adında bir adam vardı. Vergi memurlarının başıydı ve zengindi.",
    "İsa'nın nasıl bir kişi olduğunu görmek istiyordu. Ama kalabalık yüzünden O'nu göremiyordu, çünkü boyu kısaydı.",
    "Bu sebeple O'nu görebilmek için önden koşup bir yabani incir ağacına tırmandı. Çünkü İsa o yoldan geçecekti.",
    "İsa oraya gelince yukarı bakıp adama şöyle dedi: \"Zakkay, çabuk aşağı in! Bugün senin evinde misafir kalmam lazım.\"",
    "Adam aceleyle aşağı indi, İsa'yı sevinçle evine buyur etti.",
    "Oradakilerin hepsi bunu görünce söylenmeye başladılar. \"İsa günahkâr bir adamın evine girip misafir oldu!\" dediler.",
    "Zakkay ayağa kalkıp Rab İsa'ya şöyle dedi: \"İşte Efendimiz, mallarımın yarısını fakirlere veriyorum. Eğer birinden haksızlıkla bir şey aldımsa, onun dört katını geri veriyorum.\"",
    "İsa ona şöyle dedi: \"Bugün bu ev kurtuluşa kavuştu. Çünkü bu adam da İbrahim'in evladıdır.\"",
    "\"Çünkü İnsan Oğlu kaybolanı aramaya ve kurtarmaya geldi.\"",
    "Kalabalık bu sözleri dinlerken, İsa bir benzetme daha anlattı. Çünkü Yeruşalim'e yaklaşıyordu, onlar ise Tanrı'nın Krallığı'nın hemen görüneceğini sanıyorlardı.",
    ...
    "Birincisi gelip şöyle demiş: 'Efendimiz, senin bir altın paran on altın daha kazandı.'",
    ...
    "Efendisi ona, 'Sen de beş şehir üzerine yetkili olursun' demiş.",
    ...
    "Etrafta duranlara şöyle demiş: 'Adamın altın parasını alın, on parası olana verin.'",
    ...
    "İsa bunları söyledikten sonra Yeruşalim'e doğru yola çıkarak önden gitti.",
    ...
    "Onlara şöyle dedi: \"Karşıdaki köye gidin. Köye girince bağlı duran bir sıpa bulacaksınız. Ona daha önce hiç kimse binmemiştir. Onu çözüp bana getirin.\"",
    "\"Eğer biri size, 'Onu neden çözüyorsunuz?' diye sorarsa, 'Efendimiz'in ona ihtiyacı var' dersiniz.\"",
    "Gönderilen iki öğrenci, her şeyi aynen İsa'nın onlara anlattığı gibi buldular.",
    "Sıpayı çözerken hayvanın sahipleri onlara, \"Sıpayı neden çözüyorsunuz?\" diye sordular.",
    "Öğrenciler şöyle cevap verdi: \"Efendimiz'in ona ihtiyacı var.\"",
    "Sıpayı İsa'ya getirdiler, paltolarını üzerine attılar ve İsa'yı üstüne bindirdiler. İsa yoluna devam ederken, halk paltolarını yolun üzerine serdi.",
    "İsa Zeytin Dağı'ndan aşağı inen yola yaklaşmıştı. Öğrencilerinden oluşan kalabalık sevinç içindeydi. Görmüş oldukları bütün mucizeler için yüksek sesle Tanrı'yı övmeye başladılar.",
    "Şöyle dediler: \"Rabbin adıyla gelen Kral'a övgüler olsun! Gökte esenlik, en yücelerde Olan'a yücelik olsun!\"",
    "Kalabalığın içinde bazı Ferisiler vardı. İsa'ya \"Öğretmen, öğrencilerini sustur!\" dediler.",
    "O da şöyle cevap verdi: \"Size diyorum ki, bunlar sussalar bile taşlar bağırır.\"",
    "İsa Yeruşalim'e yaklaşınca, şehri görüp onun için ağladı.",
    ...
    "\"Seni de, içinde bulunan evlatlarını da yerle bir edecekler. Sende taş üstünde taş bırakmayacaklar. Çünkü Tanrı'nın seni ziyaret ettiği zamanı fark etmedin.\"",
    "Sonra İsa tapınağın avlusuna girip satıcıları kovmaya başladı.",
    "Onlara şöyle dedi: \"Kitap'ta şöyle yazılıdır: 'Benim evim ibadet evi olacak.' Ama siz onu 'haydut yatağına' çevirdiniz.\"",
    "İsa her gün tapınak avlusunda vaaz ediyordu. Başrahipler, Tevrat uzmanları ve halkın liderleri O'nu yok etmek için bir yol arıyorlardı.",
    "Yine de bunu nasıl yapacaklarını bilemiyorlardı. Çünkü bütün halk İsa'yı can kulağıyla dinliyordu.",
  ],
  // Luka 20 (47 ayet)
  [
    "İsa bir gün tapınak avlusunda halka vaaz edip Müjde'yi bildiriyordu. O zaman başrahipler, Tevrat uzmanları ve halkın liderleri O'na yaklaştılar.",
    "\"Söyle bize bakalım\" dediler. \"Bu şeyleri ne yetkiyle yapıyorsun? Sana bu yetkiyi veren kim?\"",
    "İsa onlara şöyle cevap verdi: \"Ben de size bir soru soracağım. Bana söyleyin: Yahya'nın vaftiz etme yetkisi nereden geldi? Tanrı'dan mı yoksa insandan mıydı?\"",
    "Bu soruyu aralarında tartışıp şöyle dediler: \"'Tanrı'dan' dersek, 'O zaman ona neden inanmadınız?' diyecek.\"",
    "\"Ama 'İnsandan' dersek, bütün halk bizi taşlayacak, çünkü hepsi Yahya'nın peygamber olduğuna inanıyor.\"",
    ...
    "\"Böylece, sahibin oğlunu bağdan dışarı atıp öldürmüşler.\"",
    "\"Peki, bunun sonunda bağ sahibi onlara ne yapacak? Gelip o bağcıları yok edecek, üzüm bağını da başkalarına verecek.\"",
    "Halk bunu duyunca, \"Tanrı korusun\" dedi.",
    "İsa onların gözlerinin içine bakarak şöyle dedi: \"O zaman Kutsal Yazılar'daki şu söz ne demek? 'İnşaatçıların reddettiği taş, binanın köşe taşı oldu.'\"",
    "\"Kim o taşın üzerine düşerse, paramparça olacak. O taş da kimin üzerine düşerse, onu ezip toz duman edecek.\"",
    "Tevrat uzmanları ve başrahipler o anda İsa'yı yakalamak istediler, çünkü bu benzetmeyi kendilerine karşı anlattığını anladılar. Ama halkın tepkisinden korktular.",
    "Bu yüzden İsa'yı gözlemeye başladılar. Kendilerine dürüst insan süsü veren ispiyoncular gönderdiler. İsa'yı kendi sözüyle tuzağa düşürmek istiyorlardı. Bunu İsa'yı valinin hükmüne ve yetkisine teslim edebilmek için yaptılar.",
    "Böylece İsa'ya sordular: \"Öğretmenimiz, biliyoruz ki, sen doğru olanı söylüyorsun ve öğretiyorsun. İnsanlar arasında ayrım yapmıyorsun, Tanrı'nın yolunu dürüstlükle öğretiyorsun.\"",
    "\"Sezar'a vergi ödememiz Tevrat'a uygun mu, değil mi?\"",
    "Ama İsa onların hilesini anlayıp şöyle dedi: \"Bana bir gümüş para gösterin! Üzerinde kimin resmi var, kimin adı yazılı?\"",
    "\"Sezar'ın\" dediler.",
    "İsa da onlara şöyle dedi: \"Öyleyse, Sezar'ın hakkını Sezar'a verin, Tanrı'nın hakkını da Tanrı'ya verin.\"",
    "İspiyoncular İsa'yı halkın önünde söylediği sözlerle tuzağa düşüremediler. O'nun cevabına hayret ederek susup kaldılar.",
    "Sonra İsa'ya bazı Sadukiler geldi. Sadukiler \"Ölüler dirilmez\" derler.",
    "İsa'ya şunu sordular: \"Öğretmenimiz, Tevrat'ta Musa bize şöyle buyurur: 'Eğer evli bir adam çocuksuz ölürse, adamın kardeşi ölen kardeşinin karısını alsın ve kardeşinin soyunu devam ettirsin.'\"",
    ...
    "\"Bu durumda ölüler dirildiği zaman kadın kimin karısı olacak? Çünkü bu kadın yedi kardeşin de karısı olmuştu.\"",
    "İsa onlara şöyle cevap verdi: \"Bu dünyanın insanları karı alırlar, kocaya giderler.\"",
    "\"Ama gelecek dünyaya ve ölümden dirilişe kavuşmaya layık sayılanlar, ne karı alırlar, ne de kocaya giderler.\"",
    "\"Böyleleri bir daha ölemez, melekler gibi olurlar. Ölümden dirilenler olarak Tanrı'nın oğulları olurlar.\"",
    "\"Musa yanan çalı hakkındaki bölümde ölülerin dirildiğine işaret ediyor. Orada Rab için, 'İbrahim'in Tanrısı, İshak'ın Tanrısı ve Yakub'un Tanrısı' der.\"",
    "\"Tanrı ölülerin değil, yaşayanların Tanrısı'dır. Çünkü O'nun gözünde herkes hâlâ yaşıyor.\"",
    "Bazı Tevrat uzmanları söze karışıp şöyle dedi: \"Öğretmenimiz, iyi cevap verdin.\"",
    "Çünkü kimse artık İsa'ya soru sormaya cesaret etmedi.",
    "Sonra İsa onlara şöyle dedi: \"İnsanlar Mesih'e neden Davud Oğlu diyorlar?\"",
    "\"Çünkü Davud Mezmurlar kitabında şöyle diyor: 'Rab Efendim'e dedi ki, Senin düşmanlarını ayaklarına basamak yapacağım. O zamana kadar sağımda otur.'\"",
  ...
  [
    ...
    "O'na şunu sordular: \"Peki öğretmenimiz, bunlar ne zaman olacak, ve bunların yerine geleceğini gösteren işaret nedir?\"",
    "İsa şöyle dedi: \"Sakın aldanmayın. Çünkü birçok kişi benim adımla gelip 'Ben O'yum!' ve 'Vakit yaklaştı!' diyecek. Onların peşinden gitmeyin.\"",
    ...
    "\"Ama bütün bunlar olmadan önce, sizi yakalayacaklar, size eziyet edecekler. Sizi Yahudilerin toplantı yerlerine sürükleyip hapishaneye atacaklar.\"",
    "\"Bana bağlı olduğunuz için sizi kralların ve valilerin önüne çıkaracaklar. Bütün bunlar benim adım yüzünden sizin başınıza gelecek.\"",
    ...
    "\"Bana bağlı olduğunuz için herkes sizden nefret edecek.\"",
    "\"Ama saçınızın tek bir teli bile yok olmayacak.\"",
    "\"Acılara dayanarak asıl hayat bulursunuz.\"",
    "\"Yeruşalim'in askerler tarafından kuşatıldığını gördüğünüz zaman, bilin ki, onun yıkılışı yaklaşmıştır.\"",
    "\"O zaman Yahudiye'dekiler dağlara kaçsınlar. Şehrin içindekiler oradan çıksınlar. Kırdakiler de şehre girmesinler.\"",
    "\"Çünkü bunlar ceza günleridir. Böylece Kutsal Kitap'ta yazılan her şey yerine gelecek.\"",
    "\"Vay o günlerde hamile olanların ve bebek emzirenlerin haline! Çünkü ülkede büyük sıkıntı olacak ve bu halk Tanrı'nın öfkesine uğrayacak.\"",
    ...
    "\"O zaman İnsan Oğlu'nun bulut içinde büyük güç ve görkemle geldiğini görecekler.\"",
    "\"Bu olaylar olmaya başlayınca, dik durup başlarınızı kaldırın, çünkü kurtuluşunuz yaklaşıyor.\"",
    "Sonra onlara bir benzetme anlattı: \"İncir ağacına ve bütün ağaçlara bakın.\"",
    "\"Ağaçların yaprak çıkardığını görünce yaz mevsiminin yaklaştığını bilirsiniz.\"",
    "\"Bunun gibi, bu olayların gerçekleştiğini görünce bilin ki, Tanrı'nın Krallığı yakındır.\"",
    ...
    "\"Her an tetikte durun. Dua edin ki, gelecek olan bütün bu şeylerden kaçmaya gücünüz olsun ve İnsan Oğlu'nun önünde durabilesiniz.\"",
    "İsa gündüz tapınak avlusunda vaaz ediyordu. Geceleyin de şehirden çıkıp Zeytin Dağı denilen tepede kalıyordu.",
    "Bütün halk O'nu dinlemek için sabah erkenden tapınağa geliyordu.",
  ],
  // Luka 22 (71 ayet)
  [
    "Yahudilerin Mayasız Ekmek Bayramı yaklaşıyordu. Bu bayrama aynı zamanda \"Özgürlük Bayramı\" da deniliyor.",
    "Başrahipler ve Tevrat uzmanları İsa'yı öldürmenin uygun bir yolunu arıyorlardı. Çünkü halktan korkuyorlardı.",
    "Bu arada Şeytan, İsa'nın on iki elçisinden biri olan Yahuda İskariyot'un içine girdi.",
    "Yahuda, başrahipler ve tapınağın güvenlik görevlileriyle danışmaya gitti. İsa'yı tutuklamaları için nasıl yardım edebileceğini konuştu.",
    "Onlar buna sevindiler. Kendisine para vermek için anlaştılar.",
    "O da razı geldi. Kalabalıktan uzakta, İsa'ya ihanet etmek için fırsat kollamaya başladı.",
    "Mayasız Ekmek Bayramı'nın birinci günü geldi. O gün kurban kuzusunun kesilmesi lazımdı. İsa, Petrus ve Yuhanna'ya, \"Gidin! Hazırlık yapın da bayram yemeğini yiyelim\" dedi ve onları önden gönderdi.",
    "Onlar da İsa'ya, \"Onu nerede hazırlamamızı istiyorsun?\" diye sordular.",
    ...
    "\"O zaman size üst katta döşenmiş büyük bir oda gösterecek. Bizim için orasını hazırlayın.\"",
    "İki öğrenci gitti. Her şeyi İsa'nın anlattığı gibi buldular ve Özgürlük Bayram hazırlıklarını yaptılar.",
    ...
    "\"Çünkü size söylüyorum, bu yemek Tanrı'nın Krallığı'nda tam anlamına kavuşacak. O zamana kadar onu bir daha yemeyeceğim.\"",
    "Sonra eline bir bardak aldı. Şükrettikten sonra, \"Bunu alın, aranızda paylaşın\" dedi.",
    "\"Çünkü size söylüyorum, Tanrı'nın Krallığı gelene kadar asmanın ürününden bir daha içmeyeceğim.\"",
    ...
    "\"Gerçi İnsan Oğlu kendisi için çizilen yoldan ölüme gidiyor. Fakat O'na ihanet eden adamın vay haline!\"",
    "Bunun üzerine öğrenciler aralarında bunu kimin yapabileceğini tartışmaya başladılar.",
    "Ayrıca onlardan kimin en önemli sayılacağı konusunda aralarında çekişme oldu.",
    ...
    "\"Çünkü kim daha büyük? Sofraya oturan mı yoksa hizmet eden mi? Sofraya oturan, değil mi? Ama ben aranızda hizmet eden biri gibiyim.\"",
    ...
    "\"Öyle ki, krallığımda benim soframda yiyip içesiniz ve tahtlar üzerinde oturup İsrail'in on iki oymağını yargılayasınız.\"",
    ...
    "Simun Petrus da İsa'ya, \"Efendimiz!\" dedi. \"Ben seninle cezaevine de ölüme de gitmeye hazırım.\"",
    "İsa şöyle dedi: \"Ey Petrus, sana diyorum ki, bu gece horoz ötmeden beni tanıdığını üç defa inkâr edeceksin.\"",
    "Sonra elçilere şunu sordu: \"Sizi kesesiz, torbasız ve sandaletsiz gönderdiğim zaman bir eksiğiniz oldu mu?\"",
    ...
    "İsa dışarı çıkıp adeti olduğu gibi Zeytin Dağı'na gitti. Öğrencilerine de O'nun ardından gittiler.",
    ...
    "Sonra gökten bir melek İsa'ya göründü, O'na güç verdi.",
    "İsa derin acı çekerek daha heyecanlı bir şekilde dua etmeye başladı. O'nun teri, yere düşen iri kan damlaları gibiydi.",
    ...
    "İsa daha konuşurken birdenbire bir kalabalık geldi. On iki elçiden biri olan Yahuda onlara yol gösteriyordu. İsa'yı öpmek için yaklaştı.",
    "Ama İsa ona, \"Yahuda\" dedi. \"İnsan Oğlu'na bir öpücükle mi ihanet ediyorsun?\"",
    "İsa'nın yanında duranlar, ne olacağını anlayınca, \"Efendimiz, kılıçla vuralım mı?\" diye sordular.",
    "Onlardan biri başrahibin kölesine vurup onun sağ kulağını kesti.",
    "Ama İsa, \"Yetti artık!\" dedi. Sonra adamın kulağına dokunup onu iyileştirdi.",
    "İsa O'nun üzerine yürüyen başrahipler, tapınak güvenlik görevlileri ve halkın liderlerine şöyle dedi: \"Bir hayduda karşı çıkıyormuş gibi kılıçlarla, sopalarla mı geldiniz?\"",
    ...
    "Ondan sonra İsa'yı yakaladılar, başrahibin evine götürüp, içeri aldılar. Petrus onları uzaktan izliyordu.",
    "Görevliler avlunun ortasında bir ateş yaktıktan sonra beraber oturdular. Petrus da onların arasında oturdu.",
    "Sonra bir hizmetçi kız ateşin ışığında oturan Petrus'u gördü. Gözlerini ona dikerek şöyle dedi: \"Bu adam da İsa'yla birlikteydi.\"",
    "Ama Petrus, \"Kadın, ben O'nu tanımıyorum\" diye inkâr etti.",
    "Az bir zaman sonra başkası onu görüp, \"Sen de onlardan birisin\" dedi. Ama Petrus, \"Yok arkadaş, ben değilim\" dedi.",
    "Aşağı yukarı bir saat geçtikten sonra yine başkası ısrarla şöyle dedi: \"Gerçekten bu adam İsa'yla beraberdi. Çünkü Celile'dendir.\"",
    "Ama Petrus, \"Arkadaş, sen ne diyorsun, anlamıyorum\" dedi. Tam o anda, Petrus daha konuşurken, horoz öttü.",
    "Rab İsa da dönüp Petrus'a baktı. O zaman Petrus Rabbin şu sözünü hatırladı: \"Horoz ötmeden, bu gece sen beni üç defa inkâr edeceksin.\"",
    "Bunun üzerine Petrus dışarı çıkıp acı acı ağladı.",
    "İsa'yı tutuklayan adamlar O'nunla alay ediyor, O'nu dövüyorlardı.",
    "Gözlerini bağlayıp O'na ikide bir sordular: \"Haydi peygamberliğini göster! Sana vuran kim?\"",
    "O'na daha bir sürü aşağılayıcı söz söylediler.",
    "Sabah olunca halkın liderleri toplandı. Toplantı başrahipler ve Tevrat uzmanlarından oluşuyordu. İsa'yı Meclisleri'nin önüne çıkarttılar.",
    "O'na şöyle dediler: \"Eğer sen Mesih'sen, bize söyle.\"",
    "İsa onlara şöyle cevap verdi: \"Eğer size söylersem, kesinlikle inanmazsınız. Ve eğer size bir şey sorarsam, kesinlikle cevap vermezsiniz.\"",
    "\"Ama bundan sonra İnsan Oğlu kudret sahibi olan Tanrı'nın sağında oturacak.\"",
    "Hepsi bir ağızdan şunu sordular: \"Yani, sen Tanrı'nın Oğlu musun?\" İsa onlara, \"Söylediğiniz gibi, ben O'yum\" dedi.",
    "\"Artık şahitliğe ne ihtiyacımız var?\" dediler. \"Söylediklerini biz kendimiz O'nun ağzından işittik!\"",
  ],
  // Luka 23 (56 ayet)
  [
    "Sonra toplantıdaki herkes kalkıp İsa'yı Pilatus'a götürdüler.",
    "O'nu suçlamaya başladılar. \"Bu adam var ya!\" dediler. \"Milletimizi yoldan saptırırken yakaladık. Bir de Sezar'a vergi ödenmesine karşı çıkıyor. Aynı zamanda kendisinin Mesih, yani kral olduğunu söylüyor.\"",
    "Pilatus İsa'ya, \"Sen Yahudilerin kralı mısın?\" diye sordu. İsa ona şöyle cevap verdi: \"Bunu sen söylüyorsun.\"",
    "Pilatus başrahiplere ve kalabalığa, \"Ben bu adamda hiçbir suç bulmuyorum\" dedi.",
    "Onlar ise ısrarla şöyle dediler: \"Bütün Yahudiye'de vaaz ederek halkı kışkırtıyor. Celile'den başlayarak ta buraya kadar geldi.\"",
    "Pilatus bunu duyunca, \"Bu adam Celile'den mi?\" diye sordu.",
    "İsa'nın Hirodes'in yetkisi altındaki bölgeden olduğunu öğrenince, O'nu Hirodes'in yanına gönderdi. Çünkü Hirodes de o arada Yeruşalim'deydi.",
    "Hirodes İsa'yı görünce çok sevindi. Uzun zamandan beri O'nu görmek istiyordu. Çünkü O'nun hakkındaki haberleri duymuştu ve O'nun bir mucizesini görmeyi umut ediyordu.",
    "İsa'ya birçok soru sordu. Ama İsa hiç cevap vermedi.",
    "Başrahipler ve Tevrat uzmanları da orada durup İsa'yı ağır dille suçladılar.",
    "Hirodes de askerleriyle birlikte İsa'yı aşağılayıp alay etti. Sonra O'na gösterişli bir kaftan giydirip, Pilatus'a geri yolladı.",
    "Aynı gün Hirodes ile Pilatus arkadaş oldular. Daha önce birbirlerine düşmandılar.",
    "Ondan sonra Pilatus başrahipleri, halkın liderlerini ve halkı bir araya çağırdı.",
    "Onlara şöyle dedi: \"Siz bana bu adamı halkı saptıran biri diye getirdiniz. Ben de O'nu önünüzde sorguya çektim. Ama O'nu yüklediğiniz suçlamaların hiçbirinden suçlu bulmadım.\"",
    "\"Üstelik Hirodes de bir şey bulamadı, çünkü O'nu bize geri gönderdi. Bakın, adam ölümü hak edecek hiçbir şey yapmadı.\"",
    "\"Bunun için O'nu kamçılatıp, serbest bırakacağım.\"",
    "Ama onlar hep bir ağızdan şöyle bağırdılar: \"Bu adamı yok et! Bize Barabba'yı serbest bırak!\"",
    "Barabba şehirdeki ayaklanma ve adam öldürme suçları yüzünden cezaevine atılmıştı.",
    "Pilatus İsa'yı serbest bırakmak istediği için sesini yükseltip onlarla bir daha konuştu.",
    "Ama onlar hep, \"O'nu çarmıha ger, O'nu çarmıha ger!\" diye bağrıştılar.",
    "Pilatus üçüncü defa, \"Adam ne kötülük yaptı ki? O'nda ölüm cezasını hak eden hiçbir suç bulmadım. Bu nedenle O'nu kamçılatıp serbest bırakacağım\" dedi.",
    "Fakat onlar yüksek sesle bağırarak ısrarla İsa'nın çarmıha gerilmesini istediler. Onların sesleri üstün geldi.",
    "Pilatus da onların isteğini yerine getirmeye karar verdi.",
    "İstedikleri kişiyi, Barabba'yı serbest bıraktı. O, ayaklanma ve adam öldürme suçları yüzünden hapishaneye atılmıştı. İsa'yı da onların isteğine teslim etti.",
    "Askerler İsa'yı götürürken, şehir dışından gelen Kireneli Simun adındaki adamı yakaladılar. İsa'nın arkasından taşıması için çarmıhı sırtına yüklediler.",
    "Halktan büyük bir kalabalık İsa'yla birlikte gidiyordu. Aralarında O'nun için ağlayıp dövünen kadınlar da vardı.",
    ...
    "Ayrıca iki suçlu İsa'yla birlikte ölüme götürülüyordu.",
    "Kafatası denilen yere geldiler. Orada İsa'yı ve suçluları birer çarmıha gerdiler. Suçlulardan biri İsa'nın sağında, öbürü ise solundaydı.",
    "O zaman İsa şöyle dedi: \"Baba, onları bağışla. Çünkü ne yaptıklarını bilmiyorlar.\" Askerler İsa'nın elbiselerini aralarında paylaşmak için kura çektiler.",
    "Halk etrafta durmuş bakıyordu. Halkın liderleri de İsa'yla alay ettiler. \"Başkalarını kurtardı. Eğer O Tanrı'nın Mesihi, Tanrı'nın seçtiği kişiyse kendini de kurtarsın bakalım!\" diyorlardı.",
    "Askerler de İsa'yla alay ettiler. Yaklaşıp O'na ekşi şarap uzattılar.",
    "\"Eğer sen Yahudilerin kralıysan, kendini kurtar bakalım\" dediler.",
    "İsa'nın başının üzerinde bir de şöyle bir yazı vardı: Yahudilerin Kralı budur.",
    "Çarmıha gerilmiş suçlulardan biri İsa'yı aşağılamaya başladı. \"Sen Mesih değil misin? Haydi kendini de bizi de kurtar!\" dedi.",
    "Ama öbürü onu azarladı. \"Sen Tanrı'dan hiç mi korkmuyorsun?\" diye karşılık verdi. \"Sen de aynı ölüm cezasını çekiyorsun.\"",
    ...
    "Oradaki yüzbaşı bunu görünce Tanrı'yı yüceltti ve şöyle dedi: \"Bu adam gerçekten iyi bir insandı!\"",
    "Büyük bir kalabalık olanları görmek için toplanmıştı. Olanları seyrettikten sonra göğüslerine vura vura evlerine döndüler.",
    "İsa'nın bütün tanıdıkları ve O'nunla beraber Celile'den gelen kadınlar ise olanlara uzaktan bakıp duruyorlardı.",
    "Meclis üyelerinden Yusuf adında iyi ve doğru bir adam vardı.",
    "Yusuf Yahudilerin Aramatya kasabasındandı. Meclis'in kararına ve yaptıklarına hiç razı gelmemişti. Tanrı'nın Krallığı'nı umutla bekleyen biriydi.",
    "Pilatus'a gidip İsa'nın ölüsünü istedi.",
    "Ondan sonra O'nu çarmıhtan indirip bir keten beze sardı. Kayanın içine oyulmuş bir mezara yatırdı. Oraya daha önce hiç kimse yatırılmamıştı.",
    "Hazırlık Günü'ydü ve Şabat günü başlamak üzereydi.",
    "İsa'yla beraber Celile'den gelmiş olan kadınlar Yusuf'u arkadan izlediler. Mezarı ve İsa'nın cesedinin oraya nasıl koyulduğunu gördüler.",
    "Sonra dönüp cenaze için güzel kokular ve hoş kokulu yağlar hazırladılar. Şabat gününde Tanrı'nın buyruğuna göre hiçbir iş yapmadılar.",
  ],
  // Luka 24 (53 ayet)
  [
    ...
    "İçeri girdiklerinde Rab İsa'nın cesedini bulmadılar.",
    "Bu olaya şaşıp dururken, yanlarında aniden çok parlak elbiseler içinde iki adam durdu.",
    "Kadınlar korkuyla başlarını yere eğdiler. Adamlar onlara, \"Diri Olan'ı neden ölülerin arasında arıyorsunuz?\" dedi.",
    "\"O burada yok. Dirildi. Hatırlarsınız, O daha Celile'deyken size şunu söylemişti: İnsan Oğlu'nun günahlı adamların ellerine verilmesi, çarmıha gerilmesi ve üçüncü gün dirilmesi lazım.\"",
    "O zaman İsa'nın sözlerini hatırladılar.",
    "Mezardan dönünce bütün bu şeyleri on bir öğrenciye ve diğer öğrencilere anlattılar.",
    "Bunları elçilere anlatanlar Mecdelli Meryem, Yohanna, Yakub'un annesi olan Meryem ve onlarla beraber olan diğer kadınlardı.",
    ...
    "Tam o günde öğrencilerin ikisi Emmaus adında bir köye gidiyordu. Yeruşalim'den aşağı yukarı on bir kilometre uzaklıktaydı.",
    "Bütün olup bitenleri aralarında konuşuyorlardı.",
    "Onlar konuşup tartışırken, İsa'nın kendisi yaklaştı, onlarla beraber yürümeye başladı. Ama öğrencilerin gözleri O'nu tanımaktan alıkonuldu.",
    "İsa onlara sordu, \"Yürürken birbirinizle konuşup tartıştığınız şeyler neydi?\" Onlar da durup üzgün üzgün bakıştılar.",
    "O zaman onlardan Kleopas adlı adam İsa'ya şöyle dedi: \"Yeruşalim'de misafir olan ve bu günlerde orada olup biten olaylardan haberi olmayan tek kişi sen misin?\"",
    "O da onlara \"Hangi olup bitenlerden?\" diye sordu. O'na, \"Nasıralı İsa hakkındaki olaylardan\" dediler. \"O, Tanrı'nın ve bütün halkın gözünde yaptıklarıyla ve söyledikleriyle gücünü gösteren bir peygamberdi.\"",
    "\"Oysa başrahipler ve halkımızın liderleri O'nu ölüm cezasına çarptırılması için Romalılara teslim ettiler. Onlar da O'nu çarmıha gerdiler.\"",
    "\"Ama biz O'nun İsrail halkını esirlikten kurtaracak kişi olduğunu umuyorduk. Hem de bu olaylar olalı üç gün oldu.\"",
    "\"Bu yetmezmiş gibi, aramızdan bazı kadınlar da bizi şaşırttı. Bu sabah erkenden mezara varmışlar.\"",
    "\"Ama O'nun ölüsünü bulamamışlar. Dönüp olağanüstü bir görüntüde melekler gördüklerini anlattılar. Onlara görünen melekler, 'İsa yaşıyor' demiş.\"",
    "\"Bizimle beraber olan birkaç kişi mezara gitmiş ve durumu kadınların anlattığı gibi bulmuşlar. Ama İsa'nın kendisini görmemişler.\"",
    "İsa onlara şöyle dedi: \"Sizi akılsız insanlar! Peygamberlerin söylediklerine iman etmekte ne kadar ağır davranıyorsunuz!\"",
    "\"Mesih'in bu acıları çekmesi ve sonra yüceliğine kavuşması lazım değil miydi?\"",
    "Bunun üzerine Musa ve bütün peygamberlerden başlayarak, Kutsal Yazılar'ın hepsinde kendisi hakkında yazılan şeyleri onlara açıkladı.",
    "Böylece gidecekleri köye yaklaştılar. Ama İsa kendisi sanki daha öteye gidecekmiş gibi yaptı.",
    "Onlarsa, \"Bizimle kal, çünkü akşam oluyor, gün bitmek üzere\" diyerek İsa'yı zorladılar. Öylelikle onlarla beraber kalmak üzere içeri girdi.",
    "İsa onlarla birlikte sofradayken eline ekmek aldı ve şükretti. Sonra ekmeği bölüp onlara vermeye başladı.",
    "O vakit onların gözleri açıldı. O'nu tanıdılar. Ama İsa onların gözleri önünde kaybolup gitti.",
    "Birbirlerine şöyle dediler: \"O bizimle yolda konuşup Kutsal Yazılar'ın anlamını açıklarken, yüreklerimiz yanıp tutuşuyordu, değil mi?\"",
    "Onlar da aynı saatte kalkıp Yeruşalim'e döndüler. On bir elçiyi ve onlarla beraber olanları toplanmış buldular.",
    "Elçiler ve diğerleri, \"Rab gerçekten dirildi ve Simun'a göründü\" diyorlardı.",
    "Gelen iki öğrenci onlara yolda neler olduğunu ve ekmeği bölerken İsa'yı nasıl tanıdıklarını anlatmaya başladı.",
    "İki öğrenci bu şeyleri anlatırken, birdenbire İsa'nın kendisi öğrencilerinin ortasında durdu. \"Size esenlik olsun!\" dedi.",
    ...
    "Ona bir parça kızarmış balık verdiler. İsa balığı alıp gözlerinin önünde yedi.",
    "Sonra onlara şöyle dedi: \"Daha sizinle beraberken aynı şu sözleri size söylemiştim: Musa'ya verilen Tevrat'ta, peygamberlerin kitaplarında ve Mezmurlar kitabında benim hakkımda yazılanların hepsinin yerine gelmesi lazım.\"",
    "Ondan sonra Kutsal Yazılar'ı anlayabilmeleri için zihinlerini açtı.",
    "Onlara şöyle dedi: \"Kutsal Yazılar'da, Mesih acı çekecek ve üçüncü gün ölümden dirilecek, diye yazılmıştır.\"",
    "\"İnsanlar tövbeye davet edilecek; tövbe edenlerin günahları affedilecek. Bu Müjde, Yeruşalim'den başlayarak bütün milletlere Mesih'in adıyla duyurulacak.\"",
    "\"Siz bu şeylerin şahitlerisiniz.\"",
    "\"İşte, Babam'ın vaat ettiğini size göndereceğim. Ama yukarıdan gelen güç üzerinize ininceye kadar bu şehirde kalın.\"",
    "Sonra İsa onları şehrin dışına, Beytanya'ya kadar götürdü. Ellerini kaldırıp onlara bereket diledi.",
    "Kendisi onları bereketlerken yanlarından ayrıldı, göğe yükseldi.",
    "Onlar da İsa'ya tapındılar. Sonra Yeruşalim'e büyük bir sevinçle döndüler.",
    "Devamlı tapınakta bulunup Tanrı'yı övüyorlardı.",
  ],
];
