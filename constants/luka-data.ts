...
export const LUKE_CHAPTER_VERSES: string[][] = [
  ...
  [
    ...
    "Elizabet'in hamileliğinin altıncı ayında Tanrı, Melek Cebrail'i Celile'de bulunan Nasıra adlı kente gönderdi.",
    "Davut'un soyundan Yusuf adındaki adamla nişanlı bir kıza gönderdi. Kızın adı Meryem'di.",
    ...
    "Elizabet Meryem'in selamını duyunca rahmindeki çocuk hopladı. Kutsal Ruh'la dolan Elizabet yüksek sesle şöyle bağırdı:",
    "\"Kadınlar arasında kutsanmış bulunuyorsun, rahminin ürünü de kutsanmıştır!",
    ...
    "Ve ömrümüz boyunca Kendi önünde kutsallık ve doğruluk içinde, Korkusuzca kendisine tapınmamızı sağlayacağına dair",
    "Atamız İbrahim'e ant içerek söz vermişti.",
    "Sen de, ey çocuk, Yüceler Yücesi'nin peygamberi diye anılacaksın. Rab'bin yollarını hazırlamak üzere önünden gidecek.",
    "Ve O'nun halkına, günahlarının bağışlanmasıyla kurtulacaklarını bildireceksin.",
    "Çünkü Tanrımız'ın yüreği merhamet doludur. O'nun merhameti sayesinde, Yücelerden doğan Güneş,",
    "Karanlıkta ve ölümün gölgesinde yaşayanlara ışık saçmak Ve ayaklarımızı esenlik yoluna yöneltmek üzere Yardımımıza gelecektir.\"",
  ...
  [
    ...
    "\"En yücelerde Tanrı'ya yücelik olsun, Yeryüzünde O'nun hoşnut kaldığı insanlara Esenlik olsun!\" dediler.",
    ...
    "Böylece Şimon, Ruh'un yönlendirmesiyle tapınağa geldi.",
    "Küçük İsa'nın annesi babası, Kutsal Yasa'nın ilgili kuralını yerine getirmek üzere O'nu içeri getirdiklerinde, Şimon O'nu kucağına aldı, Tanrı'yı överek şöyle dedi:",
    "\"Ey Rabbim, verdiğin sözü tuttun; Artık ben, kulun huzur içinde ölebilirim.",
    "Çünkü senin sağladığın,",
    "Bütün halkların gözü önünde hazırladığın kurtuluşu, Ulusları aydınlatıp",
    ...
    "Anna adında çok yaşlı bir kadın peygamber vardı. Aşer oymağından Fanuel'in kızıydı. Genç kız olarak evlenip kocasıyla yedi yıl yaşadıktan sonra dul kalmıştı.",
    "Şimdi seksen dört yaşındaydı. Tapınaktan ayrılmaz, oruç tutup dua ederek gece gündüz Tanrı'ya tapınırdı.",
    ...
    "Bayramdan sonra eve dönerlerken küçük İsa Yeruşalim'de kaldı.",
    "Bunu farketmeyen annesiyle babası, çocuğun yol arkadaşlarıyla birlikte olduğunu sanarak bir günlük yol gittiler. Sonra O'nu akrabalar ve dostlar arasında aramaya başladılar.",
  ...
  [
    ...
    "Ne var ki bölgenin kralı Hirodes, kardeşinin karısı Hirodiya'yla ilgili olayı ve kendi yapmış olduğu bütün kötülükleri yüzüne vuran Yahya'yı hapse attırdı.",
    "Böylece kötülüklerine bir yenisini ekledi.",
    "Bütün halk vaftiz olduktan sonra İsa da vaftiz oldu. Dua ederken gök açıldı ve Kutsal Ruh, bedensel görünümde, güvercin gibi O'nun üzerine indi.",
  ...
  // Luka 4 (44 ayet)
  [
    "Kutsal Ruh'la dolu olarak Şeria Irmağı'ndan dönen İsa, Ruh'un yönlendirmesiyle çölde dolaştırıldı.",
    "Kırk gün İblis tarafından denendi. O günlerde hiçbir şey yemedi. Dolayısıyla bu süre sonunda acıktı.",
    ...
    "İsa, büyüdüğü Nasıra Kenti'ne geldiğinde her zamanki gibi Şabat Günü havraya gitti.",
    "Kutsal Yazılar'ı okumak üzere ayağa kalkınca O'na Peygamber Yeşaya'nın Kitabı verildi. Kitabı açarak şu sözlerin yazılı olduğu yeri buldu:",
    "\"Rab'bin Ruhu üzerimdedir. Çünkü O beni yoksullara Müjde'yi iletmek için meshetti. Tutsaklara serbest bırakılacaklarını, Körlere gözlerinin açılacağını duyurmak için gönderdi.",
    ...
    "Havrada cinli, içinde kötü ruh olan bir adam vardı. Adam yüksek sesle, \"Ey Nasıralı İsa, bırak bizi! Bizden ne istiyorsun?\" diye bağırdı.",
  ...
  [
    ...
    "Gün doğunca öğrencilerini yanına çağırdı ve onların arasından, elçi diye adlandırdığı on iki kişiyi seçti.",
    "Petrus adını verdiği Simun, onun kardeşi Andreas, Yakup ve Yuhanna.",
    "Filipus, Bartalmay, Matta, Tomas, Alfay oğlu Yakup ve Yurtsever diye tanınan Simun.",
    "Yakup oğlu Yahuda ve İsa'ya ihanet eden Yahuda İskariot.",
    ...
    "\"Ama beni dinleyen sizlere şunu söylüyorum: Düşmanlarınızı sevin, sizden nefret edenlere iyilik yapın.",
  ...
  [
    ...
    "Öğrencilerinden ikisini yanına çağıran Yahya, \"Gelecek Olan sen misin, yoksa başkasını mı bekleyelim?\" diye sormaları için onları Rab'be gönderdi.",
    ...
    "O sırada, kentte günahkâr olarak tanınan bir kadın, İsa'nın, Ferisi'nin evinde yemek yediğini öğrenince kaymaktaşından bir kap içinde güzel kokulu yağ getirdi.",
    "İsa'nın arkasında, ayaklarının dibinde durup ağlayarak, gözyaşlarıyla O'nun ayaklarını ıslatmaya başladı. Saçlarıyla ayaklarını sildi, öptü ve yağı üzerlerine sürdü.",
  ...
  [
    ...
    "Kötü ruhlardan ve hastalıklardan kurtulan bazı kadınlar, içinden yedi cin çıkmış olan Mecdelli denilen Meryem, Hirodes'in kâhyası Kuza'nın karısı Yohanna, Suzanna ve daha birçokları İsa'yla birlikte dolaşıyordu.",
    "Bunlar, kendi olanaklarıyla İsa'ya ve öğrencilerine yardım ediyorlardı.",
    "Büyük bir kalabalığın toplandığı, insanların her kentten kendisine akın akın geldiği bir sırada İsa şu benzetmeyi anlattı: \"Ekincinin biri tohum ekmeye çıktı.",
    "Ektiği tohumlardan kimi yol kenarına düştü, ayak altında çiğnenip gökteki kuşlara yem oldu.",
    ...
    "İsa, bu benzetmenin anlamını kendisinden soran öğrencilerine, \"Tanrı Egemenliği'nin sırlarını bilme ayrıcalığı size verildi\" dedi.",
    "\"Ama başkalarına benzetmelerle sesleniyorum. Öyle ki, 'Gördükleri halde görmesinler, Duydukları halde anlamasınlar.'",
    ...
    "Cinlerden kurtulan adam İsa'nın yanında kalmak için O'na yalvardı. Ama İsa, \"Evine dön, Tanrı'nın senin için neler yaptığını anlat\" diyerek onu salıverdi.",
    "Adam da gitti, İsa'nın kendisi için neler yaptığını bütün kentte duyurdu.",
  ...
  [
    ...
    "O anda görkem içinde beliren iki kişi İsa'yla konuşmaya başladılar. Bunlar Musa ile İlyas'tı.",
    "İsa'nın yakında Yeruşalim'de gerçekleşecek olan ayrılışını konuşuyorlardı.",
    ...
    "Akıllarından geçeni bilen İsa, küçük bir çocuğu tutup yanına çekti.",
    "Onlara şöyle dedi: \"Bu çocuğu benim adım uğruna kabul eden, beni kabul etmiş olur. Beni kabul eden de beni göndereni kabul etmiş olur. Aranızda en küçük kim ise, işte en büyük odur.\"",
  ...
  [
    ...
    "Sonra şöyle dedi: \"Sizlerden birinin bir arkadaşı olur da gece yarısı ona gidip, 'Arkadaş, bana üç ekmek ödünç ver.'",
    "'Bir arkadaşım yoldan geldi, önüne koyacak bir şeyim yok' derse,",
    "öbürü içerden, 'Beni rahatsız etme! Kapı kilitli, çocuklarım da yanımda yatıyor. Kalkıp sana bir şey veremem' der mi hiç?",
    ...
    "Böylece bu kuşak, Habil'in kanından tutun da, sunakla tapınak arasında öldürülen Zekeriya'nın kanına değin, dünyanın kuruluşundan beri akıtılan bütün peygamberlerin kanından sorumlu tutulacaktır.",
    "Evet, size söylüyorum, bu kuşak sorumlu tutulacaktır.",
  ...
  [
    ...
    "Ama o köle içinden, 'Efendim gecikiyor' der, kadın ve erkek hizmetkârları dövmeye, yiyip içip sarhoş olmaya başlarsa,",
    "efendisi onun beklemediği günde, ummadığı saatte gelecek, onu şiddetle cezalandırıp imansızlarla bir tutacaktır.",
  ...
  [
    ...
    "Biri O'na, \"Ya Rab\" dedi, \"Kurtulanların sayısı az mı olacak?\"",
  ...
  [
    ...
    "Yemeğe çağrılanların başköşeleri seçtiğini fark eden İsa, onlara şu benzetmeyi anlattı:",
    "\"Biri seni düğüne çağırdığı zaman başköşeye kurulma. Belki senden daha saygın birini de çağırmıştır.",
    ...
    "Kalabalık halk toplulukları İsa'yla birlikte yol alıyordu. İsa dönüp onlara şöyle dedi:",
    "\"Biri bana gelip de babasını, annesini, karısını, çocuklarını, kardeşlerini, hatta kendi canını bile gözden çıkarmazsa, öğrencim olamaz.",
    ...
    "Çünkü temel atıp da işi bitiremezse, durumu gören herkes,",
    "'Bu adam inşaata başladı, ama bitiremedi' diyerek onunla eğlenmeye başlar.",
  ...
  [
    ...
    "Onu bulunca da sevinç içinde omuzlarına alır, evine döner;",
    "arkadaşlarını, komşularını çağırıp onlara, 'Benimle birlikte sevinin, kaybolan koyunumu buldum!' der.",
    ...
    "\"Büyük oğul öfkelendi, içeri girmek istemedi. Babası dışarı çıkıp ona yalvardı.",
    "Ama o, babasına şöyle yanıt verdi: 'Bak, bunca yıl senin için köle gibi çalıştım, hiçbir zaman buyruğundan çıkmadım. Ne var ki sen bana, arkadaşlarımla eğlenmem için hiçbir zaman bir oğlak bile vermedin.",
  ...
  [
    ...
    "Her tarafı yara içinde olan Lazar adında yoksul bir adam bu zenginin kapısının önüne bırakılırdı.",
    "Zenginin sofrasından düşen kırıntılarla karnını doyurmaya can atardı. Bir yandan da köpekler gelip onun yaralarını yalardı.",
  ...
  [
    ...
    "Onlardan biri iyileştiğini görünce yüksek sesle Tanrı'yı yücelterek geri döndü, yüzüstü İsa'nın ayaklarına kapanıp O'na teşekkür etti.",
    ...
    "(Bu ayet [17:36], bazı elyazmalarında \"Tarlada bulunan iki kişiden biri alınacak, öbürü bırakılacak\" sözleriyle yer alır; en eski elyazmalarında bulunmadığı için bu çeviride ayrı bir metin içermez.)",
    "Onlar İsa'ya, \"Bu olaylar nerede olacak, Rab?\" diye sordular. O da onlara, \"Leş neredeyse, akbabalar da oraya üşüşecek\" dedi.",
  ],
  // Luka 18 (43 ayet)
  [
    "İsa öğrencilerine, hiç usanmadan her zaman dua etmeleri gerektiğini belirten şu benzetmeyi anlattı:",
    "\"Kentin birinde Tanrı'dan korkmayan, insana saygı duymayan bir yargıç vardı.",
    "Yine o kentte bir dul kadın vardı. Yargıca sürekli gidip, 'Davacı olduğum kişiden hakkımı al' diyordu.",
    "Yargıç bir süre ilgisiz kaldı. Ama sonunda kendi kendine, 'Ben her ne kadar Tanrı'dan korkmaz, insana saygı duymazsam da, bu dul kadın beni rahatsız ettiği için hakkını alacağım' dedi.",
    "'Yoksa sürekli gelip beni canımdan bezdirecek' dedi.\"",
    ...
    "\"Biri Ferisi, öbürü vergi görevlisi iki kişi dua etmek üzere tapınağa çıktı.",
    ...
    "İsa onlara şöyle dedi: \"Size doğrusunu söyleyeyim, Tanrı'nın Egemenliği uğruna evini, karısını, kardeşlerini, annesiyle babasını ya da çocuklarını bırakan hiç kimse yoktur.",
    "Bu çağda bunların kat kat fazlasına, gelecek çağda da sonsuz yaşama kavuşacaktır.\"",
    ...
    "O, öteki uluslara teslim edilecek. O'nunla alay edecek, O'na hakaret edecekler; üzerine tükürecek.",
    "Ve O'nu kamçılayıp öldürecekler. Ne var ki O, üçüncü gün dirilecek.\"",
  ...
  [
    ...
    "Zeytin Dağı'nın yamacındaki Beytfaci ile Beytanya'ya yaklaştığında iki öğrencisini önden gönderdi.",
    "Onlara, \"Karşıdaki köye gidin\" dedi, \"Köye girince, üzerine daha hiç kimsenin binmediği, bağlı duran bir sıpa bulacaksınız. Onu çözüp bana getirin.",
    ...
    "Seni de, bağrındaki çocukları da yere çalacaklar. Sende taş üstünde taş bırakmayacaklar. Çünkü Tanrı'nın senin yardımına geldiği zamanı fark etmedin.\"",
    ...
    "İsa her gün tapınakta öğretiyordu. Başkâhinler, din bilginleri ve halkın ileri gelenleri ise O'nu yok etmek istiyorlardı.",
    "Ama bunu nasıl yapacaklarını bilemiyorlardı. Çünkü bütün halk O'nu can kulağıyla dinliyordu.",
  ],
  // Luka 20 (47 ayet)
  [
    ...
    "İsa onlara şu karşılığı verdi: \"Ben de size bir soru soracağım.",
    ...
    "O taşın üzerine eğilen herkes paramparça olacak, taş da kimin üzerine düşerse onu ezip toz edecek.\"",
    "İsa'nın bu benzetmeyi kendilerine karşı anlattığını fark eden din bilginleriyle başkâhinler O'nu o anda yakalamak istediler, ama halkın tepkisinden korktular.",
    ...
    "Muhbirler O'na, \"Öğretmenimiz, senin doğru olanı söyleyip öğrettiğini, insanlar arasında ayrım yapmaksızın Tanrı yolunu dürüstçe öğrettiğini biliyoruz.",
    "Sezar'a vergi vermemiz Kutsal Yasa'ya uygun mu, değil mi?\" diye sordular.",
    ...
    "\"Çünkü Davud Mezmurlar kitabında şöyle diyor: 'Rab Efendim'e dedi ki, Senin düşmanlarını ayaklarına basamak yapacağım.",
  ...
  [
    ...
    "Pilatus, başkâhinleri, yöneticileri ve halkı toplayarak onlara, \"Siz bu adamı bana, halkı saptırıyor diye getirdiniz\" dedi.",
    "\"Oysa ben bu adamı sizin önünüzde sorguya çektim ve kendisinde öne sürdüğünüz suçlardan hiçbirini bulmadım.",
    ...
    "(Bu ayet [23:17], en eski elyazmalarında yer almadığı için bu çeviride ayrı bir metin içermez. Bazı elyazmalarında Pilatus'un her Fısıh Bayramı'nda mahkûmlar için bir tutsağı salıvermesi gerektiği ifadesi yer alır.)",
    ...
    "Onlar ise, \"O'nu çarmıha ger, çarmıha ger!\" diye bağırıp durdular.",
    ...
    "Ne var ki onlar, yüksek sesle bağırarak İsa'nın çarmıha gerilmesi için direttiler.",
    "Sonunda bağırışları baskın çıktı ve Pilatus onların isteğinin yerine getirilmesine karar verdi.",
    "İstedikleri kişiyi, ayaklanmaya katılmaktan ve adam öldürmekten hapse atılan kişiyi salıverdi. İsa'yı ise onların isteğine bıraktı.",
    ...
    "Askerler de yaklaşıp İsa'yla eğlendiler. O'na ekşi şarap sunarak,",
    "\"Sen Yahudiler'in Kralı'ysan, kurtar kendini!\" dediler.",
    ...
    "Öğleyin on iki sularında güneş kararıp, üçe kadar bütün ülkenin üzerine karanlık çöktü.",
    "Tapınaktaki perde ortasından yırtıldı.",
  ...
  [
    ...
    "O zaman İsa'nın sözlerini anımsadılar.",
    ...
    "İsa onlara, \"Hangi olup bitenler?\" dedi. O'na, \"Nasıralı İsa'yla ilgili olaylar\" dediler. \"O adam, Tanrı'nın ve bütün halkın önünde gerek söz, gerek eylemde güçlü bir peygamberdi.\"",
    "\"Başkâhinlerle yöneticilerimiz O'nu, ölüm cezasına çarptırmak için valiye teslim ederek çarmıha gerdirdiler; oysa biz O'nun, İsrail'i kurtaracak kişi olduğunu ummuştuk.",
    "Dahası var, bu olaylar olalı üç gün oldu ve aramızdan bazı kadınlar bizi şaşkına çevirdiler.",
    "Bu sabah erkenden mezara gittiklerinde, O'nun cesedini bulamamışlar.",
    ...
    "İsa onlara, \"Sizi akılsızlar! Peygamberlerin bütün söylediklerine inanmakta ağır davranan kişiler!\" dedi.",
    "\"Mesih'in bu acıları çekmesi ve yüceliğine kavuşması gerekli değil miydi?\"",
    ...
    "Gitmekte oldukları köye yaklaştıkları sırada İsa, yoluna devam edecekmiş gibi davrandı.",
    "Ama onlar, \"Bizimle kal. Neredeyse akşam olacak, gün batmak üzere\" diyerek O'nu zorladılar. Böylece İsa onlarla birlikte kalmak üzere içeri girdi.",
