/** Filipililere — Türkçe Kutsal Kitap (Yeni Çeviri) ayet metinleri */
export const PHILIPPIANS_CHAPTER_VERSES: string[][] = [
  // Filipililere 1 (30 ayet)
  [
    ...
    "İlk günden şimdiye dek Müjde'nin yayılmasındaki işbirliğinizden dolayı,",
    "her duamda hepiniz için her zaman sevinçle dilekte bulunuyorum.",
    ...
    "Öyle ki, üstün değerleri ayırt edebilesiniz",
    "ve böylece Tanrı'nın yüceltilip övülmesi için İsa Mesih aracılığıyla gelen doğruluk meyvesiyle dolarak Mesih'in gününde saf ve kusursuz olasınız.",
    ...
    "Ancak yaşayışınız Mesih'in Müjdesi'ne layık olsun. Öyle ki, gelip sizi görsem de gelmesem de, sizin durumunuzu duyayım: Ruh'ta tek yürek olarak Müjde'nin inancı için dimdik duruyorsunuz.",
    "Hiçbir şeyden korkmayın karşıtlarınızdan. Bu onlar için bir mahvolma, size ise kurtuluş belirtisidir - ve bu Tanrı'dandır.",
    "Çünkü Mesih uğruna size yalnız O'na iman etmek değil, O'nun uğruna acı çekmek ayrıcalığı da verildi.",
    "Aynı mücadeleyi sürdürüyorsunuz. Daha önce bende gördüğünüz ve şimdi de duyduğunuz gibi.",
  ],
  // Filipililere 2 (30 ayet)
  [
    "Böylece Mesih'ten gelen bir cesaret, sevgiden doğan bir teselli ve Ruh'la bir paydaşlık varsa, yürekten bir sevgi ve sevecenlik varsa,",
    "aynı düşüncede, sevgide, ruhta ve amaçta birleşerek sevincimi tamamlayın.",
    ...
    "Öyle ki, İsa'nın adı anıldığında gökteki, yerdeki ve yer altındakilerin hepsi diz çöksün",
    ...
    "ki, yaşam sözüne sımsıkı sarılarak aralarında evrendeki yıldızlar gibi parladığınız bu eğri ve sapık kuşağın ortasında kusursuz ve saf, Tanrı'nın lekesiz çocukları olasınız.",
    "Öyle ki, boşuna koşmadığımı, boşuna emek vermediğimi görerek Mesih'in gününde övünecek bir nedenim olsun.",
    ...
    "Onu Rab'de tam bir sevinçle kabul edin. Böyle kişileri onurlandırın.",
    "Çünkü Mesih uğruna neredeyse canını verdi. Sizin bana yapamadığınız yardımı yapmak için canını tehlikeye attı.",
  ],
  // Filipililere 3 (21 ayet)
  [
    ...
    "Ölümünde O'nunla özdeşleşerek O'nu tanımak, dirilişinin gücünü ve acılarına ortak olmanın ne demek olduğunu bilmek istiyorum.",
    "Böylece ne yapıp yapıp ölümden dirilişe erişmek istiyorum.",
    ...
    "Kardeşler, kendimi bunu kazanmış saymıyorum. Ancak şunu yapıyorum: Geride kalan her şeyi unutup ileride olanlara uzanarak koşuyorum.",
    "Tanrı'nın Mesih İsa aracılığıyla yaptığı göksel çağrıda öngörülen ödülü kazanmak için hedefe doğru koşuyorum.",
