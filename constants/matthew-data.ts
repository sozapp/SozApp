...
export const MATTHEW_CHAPTER_VERSES: string[][] = [
  [
    ...
    "Ama oğlunu doğuruncaya dek Yusuf ona dokunmadı.",
  ...
  [
    ...
    "Hirodes öldükten sonra, Rab'bin bir meleği Mısır'da Yusuf'a rüyada görünerek, \"Kalk!\" dedi,",
    "\"Çocukla annesini al, İsrail'e dön. Çünkü çocuğun canına kıymak isteyenler öldü.\"",
  ...
  [
    "O günlerde Vaftizci Yahya Yahudiye Çölü'nde ortaya çıktı.",
    "Şu çağrıyı yapıyordu: \"Tövbe edin! Göklerin Egemenliği yaklaşmıştır.\"",
    ...
    "Yeruşalim, bütün Yahudiye ve Şeria yöresinin halkı ona geliyor,",
    "günahlarını itiraf ediyor, onun tarafından Şeria Irmağı'nda vaftiz ediliyordu.",
  ...
  [
    ...
    "Sonra İblis O'nu kutsal kente götürdü. Tapınağın tepesine çıkarıp, \"Tanrı'nın Oğlu'ysan, kendini aşağı at\" dedi, \"Çünkü şöyle yazılmıştır: 'Tanrı, senin için meleklerine buyruk verecek.'",
    ...
    "\"Zevulun ve Naftali bölgeleri, Şeria Irmağı'nın ötesinde, Deniz Yolu'nda, Ulusların yaşadığı Celile!",
  ...
  [
    ...
    "Bu yüzden, sunakta adak sunarken kardeşinin sana karşı bir şikâyeti olduğunu anımsarsan,",
    "Adağını orada, sunağın önünde bırak, git önce kardeşinle barış; sonra gelip adağını sun.",
    ...
    "Oysa ben size diyorum ki, hiç ant içmeyin: Ne gök üzerine, çünkü orası Tanrı'nın tahtıdır;",
    "Ne yer üzerine, çünkü orası O'nun ayak taburesidir; ne de Yeruşalim üzerine, çünkü orası Büyük Kral'ın kentidir.",
  ...
  [
    ...
    "İsa Kefarnahum'a varınca bir yüzbaşı O'na gelip,",
    "\"Ya Rab\" diye yalvardı, \"Uşağım felç oldu, evde yatıyor; korkunç acı çekiyor.\"",
  ...
  [
    ...
    "İsa, yöneticinin evine varıp kaval çalanlarla gürültülü kalabalığı görünce,",
    "\"Çekilin!\" dedi. \"Kız ölmedi, uyuyor.\" Onlar ise kendisiyle alay ettiler.",
  ...
  [
    ...
    "Bir peygamberi peygamber olduğu için kabul eden, peygambere yaraşan bir ödül alacaktır.",
    "Doğru birini doğru olduğu için kabul eden, doğru kişiye yaraşan bir ödül alacaktır.",
  ...
  [
    ...
    "Tutukevinde bulunan Yahya, Mesih'in yaptığı işleri duyunca, O'na gönderdiği öğrencileri aracılığıyla şunu sordu:",
    ...
    "Kulağı olan, işitsin!",
    "\"Bu kuşağın insanlarını neye benzeteyim? Çarşı meydanlarında oturup arkadaşlarına,",
    "'Size kaval çaldık, oynamadınız; Ağıt yaktık, dövünmediniz' diye seslenen çocuklara benziyorlar.",
  ...
  [
    ...
    "Bu, Peygamber Yeşaya aracılığıyla bildirilen şu söz yerine gelsin diye oldu:",
    "\"İşte Kulum, O'nu ben seçtim. Gönlümün hoşnut olduğu sevgili Kulum O'dur. Ruhum'u O'nun üzerine koyacağım, O da adaleti uluslara bildirecek.",
  ...
  [
    ...
    "Kayalık yerlere ekilen ise işittiği sözü hemen sevinçle kabul eden, ama kök salamadığı için ancak bir süre dayanan kişidir.",
    "Böyle biri Tanrı sözünden ötürü sıkıntı ya da zulme uğrayınca hemen sendeleyip düşer.",
    ...
    "Çağın sonunda da böyle olacak. Melekler gelecek, kötü kişileri doğruların arasından ayırıp kızgın fırına atacaklar.",
    "Orada ağlayış ve diş gıcırtısı olacaktır.\"",
  ...
  [
    "O günlerde İsa'yla ilgili haberleri duyan bölge kralı Hirodes, adamlarına, \"Bu, Vaftizci Yahya'dır\" dedi.",
    "\"Ölümden dirildi. Olağanüstü güçlerin onda etkin olmasının nedeni budur.\"",
    ...
    "Hirodes'in doğum günü şenliği sırasında Hirodiya'nın kızı ortaya çıkıp dans etti.",
    "Bu, Hirodes'in öyle hoşuna gitti ki, ant içerek kıza ne dilerse vereceğini söyledi.",
  ...
  [
    "Bu sırada Yeruşalim'den bazı Ferisiler ve din bilginleri İsa'ya gelip, \"Öğrencilerin neden atalarımızın töresini çiğniyor?\" diye sordular,",
    ...
    "Ama siz, 'Her kim anne ya da babasına, benden alacağın bütün yardım Tanrı'ya adanmıştır derse, artık babasına saygı göstermek zorunda değildir' diyorsunuz.",
    "Böylelikle, töreniz uğruna Tanrı'nın sözünü geçersiz kılmış oluyorsunuz.",
  ...
  [
    ...
    "Hâlâ anlamıyor musunuz? Beş ekmekle beş bin kişinin doyduğunu, kaç sepet dolusu yemek fazlası topladığınızı hatırlamıyor musunuz?",
    "Yedi ekmekle dört bin kişinin doyduğunu, kaç küfe dolusu yemek fazlası topladığınızı hatırlamıyor musunuz?",
  ...
  [
    ...
    "İsa, \"İmanınız kıt olduğu için\" karşılığını verdi.",
    "\"Size doğrusunu söyleyeyim, bir hardal tanesi kadar imanınız olsa şu dağa, 'Buradan şuraya göç' derseniz, göçer; sizin için imkânsız bir şey olmayacaktır.\"",
    "Celile'de bir araya geldiklerinde İsa onlara, \"İnsanoğlu, insanların eline teslim edilecek ve öldürülecek, ama üçüncü gün dirilecek\" dedi.",
  ...
  [
    ...
    "Bu küçüklerden birini bile hor görmekten sakının! Size şunu söyleyeyim, onların göklerdeki melekleri,",
    "göklerdeki Babam'ın yüzünü her zaman görürler.",
  ...
  [
    ...
    "İsa şu karşılığı verdi: \"Kutsal Yazılar'ı okumadınız mı? Yaradan başlangıçtan 'İnsanları erkek ve dişi olarak yarattı' ve şöyle dedi:",
    ...
    "O sırada bazıları küçük çocukları İsa'nın yanına getirdiler; ellerini onların üzerine koyup dua etmesini istediler. Öğrenciler onları azarlayınca",
    "İsa, \"Bırakın çocukları\" dedi. \"Bana gelmelerine engel olmayın! Çünkü Göklerin Egemenliği böylelerinindir.\"",
    ...
    "Hangi buyrukları?\" diye sordu adam. İsa şu karşılığı verdi: \"'Adam öldürmeyeceksin, zina etmeyeceksin, çalmayacaksın, yalan yere tanıklık etmeyeceksin, annene babana saygı göstereceksin'",
  ...
  [
    ...
    "İsa Yeruşalim'e giderken, yolda on iki öğrencisini bir yana çekip onlara özel olarak şunu söyledi:",
    "\"Şimdi Yeruşalim'e gidiyoruz. İnsanoğlu, başkâhinlerin ve din bilginlerinin eline teslim edilecek, onlar da O'nu ölüm cezasına çarptıracaklar.",
  ...
  [
    "Yeruşalim'e yaklaşıp Zeytin Dağı'nın yamacındaki Beytfaci Köyü'ne geldiklerinde İsa, iki öğrencisini önden gönderdi.",
    "Onlara, \"Karşınızdaki köye gidin\" dedi, \"Hemen orada bağlı bir dişi eşek ve yanında bir sıpa bulacaksınız. Onları çözüp bana getirin.",
  ...
  [
    "İsa söz alıp onlara yine benzetmelerle şöyle seslendi:",
    "\"Göklerin Egemenliği, oğlu için düğün şöleni hazırlayan bir krala benzer.",
    ...
    "Ölümden sonra diriliş olmadığını söyleyen Sadukiler, aynı gün İsa'ya gelip şunu sordular: \"Öğretmenimiz, Musa şöyle buyurmuştur:",
    "'Eğer bir adam çocuk sahibi olmadan ölürse, kardeşi onun karısını alsın, soyunu sürdürsün.'",
  ...
  [
    ...
    "(Bu ayet [23:14], en eski elyazmalarında yer almadığı için bu çeviride ayrı bir metin içermez.)",
  ...
  [
    ...
    "Peygamber Daniel'in sözünü ettiği yıkıcı iğrenç şeyin kutsal yerde dikildiğini gördüğünüz zaman -okuyan anlasın-",
    "Yahudiye'de bulunanlar dağlara kaçsın.",
    ...
    "Ama o köle kötü olur da içinden, 'Efendim gecikiyor' der,",
    "ve öteki köleleri dövmeye başlarsa, sarhoşlarla birlikte yiyip içerse,",
    "efendisi, onun beklemediği günde, ummadığı saatte gelecek,",
    "onu şiddetle cezalandırıp ikiyüzlülerle bir tutacak. Orada ağlayış ve diş gıcırtısı olacaktır.",
  ],
  [
    ...
    "Efendisi ona şu karşılığı verdi: 'Kötü ve tembel köle! Ekmediğim yerden biçtiğimi, harman savurmadığım yerden devşirdiğimi bildiğine göre paramı faize vermeliydin.",
    ...
    "yabancıydım, beni içeri almadınız; çıplaktım, beni giydirmediniz; hastaydım, zindandaydım, benimle ilgilenmediniz.'",
  ...
  [
    ...
    "İsa Beytanya'da cüzamlı Simun'un evindeyken, yanına bir kadın geldi.",
    "Kadın kaymaktaşından bir kap içinde çok değerli, güzel kokulu yağ getirmişti. İsa sofrada otururken, kadın yağı O'nun başına döktü.",
    ...
    "O sırada Onikiler'den biri -adı Yahuda İskariot olanı- başkâhinlere giderek, \"O'nu ele verirsem bana ne verirsiniz?\" dedi.",
    "Otuz gümüş tartıp ona verdiler.",
    ...
    "İsa daha konuşurken, Onikiler'den biri olan Yahuda geldi.",
    "Yanında, başkâhinlerle halkın ileri gelenleri tarafından gönderilmiş kılıçlı sopalı büyük bir kalabalık vardı.",
    ...
    "Ortaya birçok yalancı tanık çıktığı halde, aradıklarını bulamadılar.",
    "Sonunda ortaya çıkan iki kişi şöyle dedi: \"Bu adam, 'Ben Tanrı'nın Tapınağı'nı yıkıp üç günde yeniden kurabilirim' dedi.\"",
    ...
    "Bunun üzerine İsa'nın yüzüne tükürüp O'nu yumrukladılar.",
    "Bazıları da O'nu tokatlayıp, \"Ey Mesih, peygamberliğini göster bakalım, sana vuran kim?\" dediler.",
  ...
  [
    ...
    "\"İsrailoğulları'ndan kimilerinin O'na biçtikleri değerin karşılığı olan Otuz gümüşü aldılar; Rab'bin bana buyurduğu gibi, Çömlekçi Tarlası'nı satın almak için harcadılar.\"",
    ...
    "Başının üzerine, \"Bu Yahudiler'in Kralı İsa'dır\" diye yazan bir suç yaftası astılar.",
    "İsa'yla birlikte, biri sağında öbürü solunda olmak üzere iki haydut da çarmıha gerildi.",
    "Oradan geçenler başlarını sallayıp İsa'ya sövüyor, \"Hani sen tapınağı yıkıp üç günde yeniden kuracaktın?",
    "Haydi, kurtar kendini! Tanrı'nın Oğlu'ysan çarmıhtan in!\" diyorlardı.",
    "Başkâhinler, din bilginleri ve ileri gelenler de aynı şekilde O'nunla alay ederek, \"Başkalarını kurtardı, kendini kurtaramıyor\" diyorlardı.",
    "\"İsrail'in Kralı imiş! Şimdi çarmıhtan aşağı insin de O'na iman edelim.",
    ...
    "Yusuf cesedi aldı, temiz keten beze sardı, kayaya oydurduğu kendi yeni mezarına yatırdı.",
    "Mezarın girişine büyük bir taş yuvarlayıp oradan ayrıldı.",
    ...
    "Yoksa öğrencileri gelir, cesedini çalar ve halka, 'Ölümden dirildi' derler. Son aldatmaca ilkinden beter olur.\"",
  ...
  [
    ...
    "Başkâhinler ileri gelenlerle birlikte toplanıp birbirlerine danıştıktan sonra askerlere yüklü para vererek dediler ki,",
    "\"Siz şöyle diyeceksiniz: 'Öğrencileri geceleyin geldi, biz uyurken O'nun cesedini çalıp götürdüler.'",
