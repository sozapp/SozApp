...
export const MARK_CHAPTER_VERSES: string[][] = [
  ...
  [
    ...
    "İsa bunlardan on iki kişiyi yanında bulundurmak, Tanrı sözünü duyurmaya göndermek üzere seçti.",
    "Ayrıca cinleri kovmaya yetkili kılmak üzere seçti.",
    "Seçtiği bu on iki kişi şunlardır: Petrus adını verdiği Simun.",
    "Beni-Regeş, yani Gökgürültüsü Oğulları adını verdiği Zebedi'nin oğulları Yakup ve Yuhanna.",
    "Andreas, Filipus, Bartalmay, Matta, Tomas, Alfay oğlu Yakup, Taday, Yurtsever Simun.",
    "Ve İsa'ya ihanet eden Yahuda İskariot.",
    ...
    "Size doğrusunu söyleyeyim, insanların işlediği her günah, ettiği her küfür bağışlanacak, ama Kutsal Ruh'a küfreden asla bağışlanmayacak.",
  ...
  [
    ...
    "Kayalık yerlere ekilenler ise, işittikleri sözü hemen sevinçle kabul eden, ama kök salamadıkları için ancak bir süre dayanan kişilerdir.",
    "Böyleleri Tanrı sözünden ötürü sıkıntı ya da zulme uğrayınca hemen sendeleyip düşerler.",
    "Yine bazıları dikenler arasında ekilen tohumlara benzerler.",
    "Bunlar sözü işitirler, ama dünyasal kaygılar, zenginliğin aldatıcılığı ve daha başka hevesler araya girip sözü boğar ve ürün vermesini engeller.",
    ...
    "Tanrı'nın Egemenliği, hardal tanesine benzer.",
    "Hardal, yeryüzünde toprağa ekilen tohumların en küçüğü olmakla birlikte, ekildikten sonra gelişir, bütün bahçe bitkilerinin boyunu aşar. Öylesine dal budak salar ki, kuşlar gölgesinde barınabilir.\"",
  ...
  [
    ...
    "Bu sırada havra yöneticilerinden Yair adında biri geldi. İsa'yı görünce ayaklarına kapandı.",
    "\"Küçük kızım can çekişiyor. Gelip ellerini onun üzerine koy da kurtulsun, yaşasın!\" diye yalvardı.",
  ...
  [
    ...
    "Hirodes'in kendisi, kardeşi Filipus'un karısı Hirodiya'nın yüzünden adam gönderip Yahya'yı tutuklatmış, zindana attırıp zincire vurdurmuştu.",
    "Çünkü Hirodes bu kadınla evlenince Yahya ona, \"Kardeşinin karısıyla evlenmen Kutsal Yasa'ya aykırıdır\" demişti.",
    ...
    "Vakit ilerlemişti. Öğrencileri İsa'ya gelip, \"Burası ıssız bir yer\" dediler, \"Vakit de ilerledi.\"",
    "\"Halkı salıver de çevredeki çiftlik ve köylere gidip kendilerine yiyecek alsınlar.\"",
    ...
    "Herkes yiyip doydu.",
    "Artakalan ekmek ve balıktan on iki sepet dolusu topladılar.",
    ...
    "Akşam olduğunda, tekne gölün ortasına varmıştı. Yalnız başına karada kalan İsa, öğrencilerinin kürek çekmekte çok zorlandıklarını gördü. Çünkü rüzgar onlara karşı esiyordu.",
    "Sabaha karşı İsa, gölün üstünde yürüyerek onlara yaklaştı. Yanlarından geçip gidecekti.",
  ...
  [
    ...
    "Ama siz, 'Eğer bir adam annesine ya da babasına, benden alacağın bütün yardım kurbandır, yani Tanrı'ya adanmıştır' diyorsunuz.",
    "'Artık annesi ya da babası için bir şey yapmasına izin yok' diyorsunuz.",
    ...
    "(Bu ayet [7:16], en eski elyazmalarında yer almadığı için bu çeviride ayrı bir metin içermez. Bazı elyazmalarında \"İşitecek kulağı olan işitsin!\" ifadesi yer alır.)",
    ...
    "Çünkü kötü düşünceler, fuhuş, hırsızlık, cinayet, zina, açgözlülük içten, insanın yüreğinden kaynaklanır.",
    "Kötülük, hile, sefahat, kıskançlık, iftira, kibir ve akılsızlık da içten, insanın yüreğinden kaynaklanır.",
  ...
  // Markos 8 (38 ayet)
  [
    "O günlerde yine büyük bir kalabalık toplanmıştı. Yiyecek bir şeyleri olmadığı için İsa öğrencilerini yanına çağırdı.",
    "\"Halka acıyorum\" dedi. \"Üç gündür yanımdalar, yiyecek hiçbir şeyleri yok.",
    ...
    "İsa onları evlerine gönderdikten sonra öğrencileriyle birlikte hemen tekneye binip Dalmanuta bölgesine geçti.",
    ...
    "Gözleriniz olduğu halde görmüyor musunuz? Kulaklarınız olduğu halde işitmiyor musunuz? Hatırlamıyor musunuz?",
    "Beş ekmeği beş bin kişiye bölüştürdüğümde kaç sepet dolusu yemek fazlası topladınız?\" \"On iki\" dediler.",
  ...
  [
    ...
    "Küçük bir çocuğu alıp orta yere dikti, sonra onu kucağına aldı.",
    "Onlara şöyle dedi: \"Böyle bir çocuğu benim adım uğruna kabul eden, beni kabul etmiş olur. Beni kabul eden de beni değil, beni göndereni kabul etmiş olur.\"",
    ...
    "(Bu ayet [9:44], bazı elyazmalarında 48. ayetteki \"Oradakileri kemiren kurt ölmez, yakan ateş sönmez\" sözlerinin tekrarı olarak yer alır; en eski elyazmalarında bulunmadığı için bu çeviride ayrı bir metin içermez.)",
    "Eğer ayağın günah işlemene neden olursa, onu kes. Tek ayakla yaşama kavuşman, iki ayakla cehenneme atılmandan iyidir.",
    "(Bu ayet [9:46], 44. ayetle aynı biçimde, 48. ayetteki sözlerin bir tekrarıdır; en eski elyazmalarında bulunmadığı için bu çeviride ayrı bir metin içermez.)",
  ...
  [
    ...
    "\"Size doğrusunu söyleyeyim\" dedi İsa, \"Benim ve Müjde'nin uğruna evini, kardeşlerini, anne ya da babasını, çocuklarını ya da topraklarını bırakan hiç kimse yoktur.",
    "Şimdi, bu çağda çekeceği zulümlerle birlikte yüz kat daha fazla eve, kardeşe, anneye, çocuğa, toprağa ve gelecek çağda sonsuz yaşama kavuşmayacak hiç kimse yoktur.",
    "Ne var ki, birincilerin birçoğu sonuncu, sonuncuların birçoğu da birinci olacak.\"",
    "Yola çıkmış Yeruşalim'e gidiyorlardı. İsa önlerinde yürüyordu. Öğrencileri şaşkınlık içindeydi, ardından gelenler ise korkuyorlardı. İsa Onikiler'i yine bir yana çekip kendi başına gelecekleri anlatmaya başladı.",
    "\"Şimdi Yeruşalim'e gidiyoruz\" dedi. \"İnsanoğlu, başkâhinlerin ve din bilginlerinin eline teslim edilecek. Onlar da O'nu ölüm cezasına çarptıracak ve öteki uluslara teslim edecekler.\"",
    ...
    "\"Evet, olabiliriz\" dediler. İsa onlara, \"Benim içeceğim kâseden siz de içeceksiniz, benim vaftiz olacağım gibi siz de vaftiz olacaksınız\" dedi.",
    "\"Ama sağımda ya da solumda oturmanıza izin vermek benim elimde değil. Bu yerler belirli kişiler için hazırlanmıştır.\"",
  ...
  // Markos 11 (33 ayet)
  [
    "Yeruşalim'e yaklaşıp Zeytin Dağı'nın yamacındaki Beytfaci ile Beytanya'ya geldiklerinde İsa iki öğrencisini önden gönderdi.",
    "Onlara, \"Karşınızdaki köye gidin\" dedi, \"Köye girer girmez, üzerine daha hiç kimsenin binmediği, bağlı duran bir sıpa bulacaksınız. Onu çözüp bana getirin.",
    ...
    "(Bu ayet [11:26], bazı elyazmalarında \"Ama siz bağışlamazsanız, göklerdeki Babanız da sizin suçlarınızı bağışlamaz\" sözleriyle yer alır; en eski elyazmalarında bulunmadığı için bu çeviride ayrı bir metin içermez.)",
    "Yine Yeruşalim'e geldiler. İsa tapınakta gezinirken başkâhinler, din bilginleri ve ileri gelenler O'nun yanına geldiler.",
    "\"Bunları hangi yetkiyle yapıyorsun, bunları yapma yetkisini sana kim verdi?\" diye sordular.",
  ...
  [
    ...
    "Ölümden sonra diriliş olmadığını söyleyen Sadukiler İsa'ya gelip şunu sordular.",
    "\"Öğretmenimiz, Musa yazılarında bize şöyle buyurmuştur: 'Eğer bir adam ölür, geride bir dul bırakır, ama çocuk bırakmazsa, kardeşi onun karısını alıp soyunu sürdürsün.'\"",
    ...
    "İsa öğretirken şöyle dedi: \"Uzun kaftanlar içinde dolaşmaktan, meydanlarda selamlanmaktan hoşlanan din bilginlerinden sakının.",
    "Havralarda en seçkin yerlere ve şölenlerde başköşelere kurulmaktan hoşlanan din bilginlerinden sakının.",
  ...
  [
    ...
    "İsa, Zeytin Dağı'nda, tapınağın karşısında otururken Petrus, Yakup, Yuhanna ve Andreas özel olarak kendisine sordular.",
    "\"Söyle bize, bu dediklerin ne zaman olacak, bütün bunların gerçekleşmek üzere olduğunu gösteren belirti ne olacak?\"",
    ...
    "\"Ama o günlerde, o sıkıntıdan sonra, 'Güneş kararacak, Ay ışık vermez olacak,",
    "Yıldızlar gökten düşecek, Göksel güçler sarsılacak.'\"",
  ...
  [
    ...
    "Bazıları buna kızdılar; birbirlerine, \"Bu yağ niçin böyle boş yere harcandı?\" dediler.",
    "\"Üç yüz dinardan fazlaya satılabilir, parası yoksullara verilebilirdi\" diyerek kadını azarlamaya başladılar.",
    ...
    "\"Küfürü işittiniz. Buna ne diyorsunuz?\" Hepsi İsa'nın ölüm cezasını hak ettiğine karar verdiler.",
    ...
    "Petrus aşağıda, avludaydı.",
    "Başkâhinin hizmetçi kızlarından biri geldi. Isınmakta olan Petrus'u görünce onu dikkatle süzüp, \"Sen de Nasıralı İsa'yla birlikteydin\" dedi.",
  ...
  [
    ...
    "(Bu ayet [15:28], bazı elyazmalarında \"Böylece O, suçlularla bir sayıldı diyen Kutsal Yazı yerine geldi\" sözleriyle yer alır; en eski elyazmalarında bulunmadığı için bu çeviride ayrı bir metin içermez.)",
    "Oradan geçenler başlarını sallayıp İsa'ya sövüyor, \"Hani sen tapınağı yıkıp üç günde yeniden kuracaktın?\" diyorlardı.",
    ...
    "O gün Hazırlık Günü, yani Şabat Günü'nden önceki gündü. Artık akşam oluyordu.",
    "Bu nedenle, Yüksek Kurul'un saygın bir üyesi olup Tanrı'nın Egemenliği'ni umutla bekleyen Aramatyalı Yusuf geldi, cesaretini toplayarak Pilatus'un huzuruna çıktı, İsa'nın cesedini istedi.",
